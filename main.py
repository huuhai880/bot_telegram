...
async def fetch_config_price(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    price_config = requests.post(API_URL+"/cau_hinh/api_cau_hinh.php", data = data)
...
async def update_config_price(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    for entry in result:
        ...
        config_price.append({'vung_mien':entry[0],'kieu':entry[1],'co':int(entry[2]),'trung':entry[3]})
    ...
    if len(config_price) > 0:
        ...
        result_price_config = requests.post(API_URL+"/cau_hinh/api_cau_hinh.php", data = data)
...
async def pick_limit_station(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard_mn = [
        ...
        [InlineKeyboardButton(f"==Miền Nam==", callback_data="LIMIT_NUMBER_STATION")],
        ...
        [InlineKeyboardButton(f"==Miền Trung==", callback_data="LIMIT_NUMBER_STATION")],
